    ...
    <div class="row gx-5 justify-content-center">
        <div class="col-lg-11 col-xl-9 col-xxl-8">
            ...
            <section>
                ...
                <?php foreach ($db->getPengalaman() as $p): ?>
                <!-- Experience Card 1-->
                        ...
                        <div class="row align-items-center gx-5">
                            <div class="col text-center text-lg-start mb-4 mb-lg-0">
                                <div class="bg-light p-4 rounded-4">
                                    <div class="text-primary fw-bolder mb-2"><?= $p->tahun ?></div>
                                    <div class="small fw-bolder"><?= $p->pekerjaan ?></div>
                                    <div class="small text-muted"><?= $p->lokasi ?></div>
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div><?= $p->deskripsi_pekerjaan ?></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section>
                ...
                <?php foreach ($db->getSekolah() as $s): ?>
                <!-- Education Card 1-->
                <div class="card shadow border-0 rounded-4 mb-5">
                    <div class="card-body p-5">
                        <div class="row align-items-center gx-5">
                            <div class="col text-center text-lg-start mb-4 mb-lg-0">
                                <div class="bg-light p-4 rounded-4">
                                    <div class="text-secondary fw-bolder mb-2"><?= $s->tahun ?></div>
                                    <div class="mb-2">
                                        <div class="small fw-bolder"><?= $s->tingkat ?></div>
                                        <div class="small text-muted"><?= $s->lokasi ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div><?= $s->deskripsi_sekolah ?></div>
                            </div>
                        </div>
                    </div>
                </div>

    ...
    <div class="container px-5">
        ...
        <div class="bg-light rounded-4 py-5 px-4 px-md-5">
            <div class="text-center mb-5">
                ...
                <p class="lead fw-bold text-white p-3 rounded-pill bg-success d-inline-block mt-4">Total Inbox : <?= $db->getJumlahContact() ?></p>
            </div>
            <div class="row gx-5 justify-content-center">
                <div class="col-lg-8 col-xl-6">
                    ...
                    <form id="contactForm" action="lib/action.php" method="post">
                        ...
                        <!-- Phone number input-->
                        <div class="form-floating mb-3">
                            <input name="nohp" class="form-control" id="phone" type="tel" placeholder="(123) 456-7890" required />
